<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Dobrodošli v aplikaciji BookCatcher!
    </div>

    <div class="mt-6 text-gray-500">
        BookCatcher predstavlja moje diplomsko delo. Na jeje boste lahko našli vaše najljubše knjige, ki si jih že dolgo želite prebrati.
    </div>
</div>
